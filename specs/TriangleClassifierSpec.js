...
describe('TriangleClassifier', function() {
  ...
  it('classifies as isosceles 3,3,6', function() {
    var result = new TriangleClassifier().classify(3,3,6);
    expect(result).toEqual('isosceles');
  });
  it('classifies as equilateral 6,6,6', function() {
    var result = new TriangleClassifier().classify(6,6,6);
